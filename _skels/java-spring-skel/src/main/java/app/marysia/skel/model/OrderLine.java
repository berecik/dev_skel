 ...
 *
 * <p>The reference to {@link CatalogItem} is lazy + JSON-ignored so the
 * line serialises with scalar IDs only — controllers project a richer
 * {@code item_name} into the response when needed.
 */
@Entity
