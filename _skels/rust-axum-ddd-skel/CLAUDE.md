# Claude Code Rules — `rust-axum-ddd-skel`

Claude-specific complement to `_skels/rust-axum-ddd-skel/AGENTS.md` and
`_skels/rust-axum-ddd-skel/JUNIE-RULES.md`. Read those first.
...
1. `_skels/rust-axum-ddd-skel/CLAUDE.md` (this file)
2. `_skels/rust-axum-ddd-skel/AGENTS.md`
3. `_skels/rust-axum-ddd-skel/JUNIE-RULES.md`
